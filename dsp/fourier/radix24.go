...
//
// If the length of seq is not an integer power of 2, SequenceRadix2
// will panic.
...
// TrimRadix2 return the largest slice of x that is has an integer
...
// multiply the input sequence by the length of the sequence.
//
// If the length of seq is not an integer power of 4, SequenceRadix4
// will panic.
...
// TrimRadix4 return the largest slice of x that is has an integer
